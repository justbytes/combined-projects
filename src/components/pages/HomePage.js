    ...
    <Container fluid>
      ...
      <Card>
        ...
        <Card.Body>
          <Card.Text>
            ...
            frameworks so I decided to throw all these projects into one mobile
            responsive, user-friendly and well polished React App. There are
            some projects that didn't fit the metaphorical bill but you can
            still check them out on my Github if your interested.
          </Card.Text>
        </Card.Body>
      </Card>
      <h1>The Projects</h1>
      <div className="card-wrapper">
        ...
        >
          ...
          <Card.Body>
            <Card.Text>
              With options to include character length, uppercase and lowercase
              letters, numbers, and special characters, this tool can generate
              strong and unique passwords that can slow down even the most
              determined attackers. While it may not stop Mr. Robot, it can
              definitely boost your online security.
            </Card.Text>
          </Card.Body>
        </Card>
        <Card
        ...
        >
          ...
          <Card.Body>
            <Card.Text>
              A 10 question quiz on the React framework. You'll have 45 seconds
              to complete the quiz and your score will shown at the end.
            </Card.Text>
          </Card.Body>
        </Card>
      </div>
